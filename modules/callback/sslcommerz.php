...
if ($status=="success") {
    # Successful
    $fee='';
    addInvoicePayment($invoiceid,$transid,$orderData['total'],$fee,$gatewaymodule); # Apply Payment to Invoice: invoiceid, transactionid, amount paid, fees, modulename
